...
def parse_player_season_totals(row):
    return {
        ...
        "made_two_point_field_goals": str_to_int(row[14].text_content()),
        "attempted_two_point_field_goals": str_to_int(row[15].text_content()),
        ...
        "total_rebounds": str_to_int(row[23].text_content()),
        ...
        "points": str_to_int(row[29].text_content()),
    }

def parse_season_totals_for_players(page):
